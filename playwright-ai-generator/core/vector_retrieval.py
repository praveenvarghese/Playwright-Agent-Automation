...
# Load environment variables from the shared .env (one level above this file)
dotenv_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '.env'))
load_dotenv(dotenv_path)
print("✅ Loaded .env from:", dotenv_path)
print("DEBUG ENV:", os.getenv("AZURE_SEARCH_ENDPOINT"), os.getenv("AZURE_SEARCH_API_KEY"), os.getenv("AZURE_SEARCH_INDEX_NAME"))
